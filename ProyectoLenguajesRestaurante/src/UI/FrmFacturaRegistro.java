...
// a otra fecha en el total de ventas del restaurante
public class FrmFacturaRegistro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         // Carga facturas desde la Base de Datos
        factura.leerFacturas();
        
        // Se Obtiene el valor desde el JComboBox y se pasa a un Int
        ...
        // Se crean las dos fechas con los datos obtenidos
        ...
        // Esta funcion es la encargada de calcular el total de una fecha a otra
        double montoTotal = factura.calcularSumaTotalEnRango(fechaInicio, fechaFin);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFacturaRegistro().setVisible(true);
            }
        });
    }
