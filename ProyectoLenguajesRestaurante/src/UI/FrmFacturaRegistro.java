...
public class FrmFacturaRegistro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        factura.leerFacturas(); // cargar facturas desde la bd
...
//        int mesInicio = (int)this.jComboBox2.getSelectedItem();
//        int diaInicio = (int)this.jComboBox3.getSelectedItem();
//        
//        int annoFin = (int)this.jComboBox4.getSelectedItem();
//        int mesFin = (int)this.jComboBox5.getSelectedItem();
//        int diaFin = (int)this.jComboBox6.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFacturaRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
